...
public class PDFConvertor {
	...
	public static void main(String[] args) throws Exception {
		// 확장자명까지 작성해주어야함.
		PDFConvertor.JPGconvertor("자료구조.pdf");
	}
	...
	public static ArrayList<String> PPTXtoJPG(String PPTName) throws Exception {
		...
		XMLSlideShow ppt = new XMLSlideShow(is); // InputStream 클래스 객체를 전달하여이 클래스를 인스턴스화 
		is.close();
		...
		Dimension pgsize = ppt.getPageSize(); // 현재 페이지의 크기를 알수 있다.

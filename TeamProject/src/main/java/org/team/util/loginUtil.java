...
public class loginUtil {
	public static String Success(HttpServletRequest req, HttpServletResponse res, 
			String userid, String userpw) throws Exception {
	...
	public static String Geust(HttpServletRequest req, HttpServletResponse res, 

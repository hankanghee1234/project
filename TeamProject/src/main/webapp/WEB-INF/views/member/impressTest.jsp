...
<!--
    ...
    -->
<link href="../resources/impress.js-master/css/impress-demo.css"
	rel="stylesheet">
...
-->
<div id="impress" style="position: absolute; transform-origin: left top 0px; transition: all 500ms ease-in-out 250ms; transform-style: preserve-3d; top: 50%; left: 50%; perspective: 1484.06px; transform: scale(0.673828);"><div style="position: absolute; transform-origin: left top 0px; transition: all 500ms ease-in-out 0ms; transform-style: preserve-3d; transform: rotateZ(0deg) rotateY(0deg) rotateX(0deg) translate3d(1000px, 1500px, 0px);">
    ...
    -->
    <div id="bored" class="step slide present active" data-x="-1000" data-y="-1500" style="position: absolute; transform: translate(-50%, -50%) translate3d(-1000px, -1500px, 0px) rotateX(0deg) rotateY(0deg) rotateZ(0deg) scale(1); transform-style: preserve-3d;">
...
-->
<script src="../resources/impress.js-master/js/impress.js"></script>

...
<body>
						...
						<div class="panel-body" style="text-align: center;">
							<div class="modal-body col-md-12" style="line-height: 10px;">
								<form role="form" action="updatePost" method="post">
									...
									<p>
										<input type="hidden" name="uimg" id="imgsrc">
									</p>
					...
					<div class="modal-content modal-upload">
						...
						<div class="panel-body" style="text-align: center;">
							<form id="ddd" action="update" method="post">
								...
								<input id="upFno" type="hidden" name="fno" value="1"> <br>
								<p>
				...
				<div class="col-md-5">
					<div class="panel">
							...
							<div class="col-md-12 padding-0">
								<div class="col-md-8" style="padding-left: 2px;">
									...
									<form method="get" id="sf">
										<input id="spageHidden" type="hidden" name="page"
											value="${pageMaker.current}"> <input id="fnoHidden"
											type="hidden" name="fno" value="1"> <select
											name="searchType">
											<option value="n"
										...
										<div class="input-group">
											<div class="input-group-text">
												<input type="text" class="form-control" name="keyword"
													id="keywordInput" placeholder="검색명을 입력하세요"
													value="${cri.keyword}">
											</div>
											<!-- /input-group -->
						...
						<div class="panel-body" align="center">
										...
										<c:forEach items="${pptUserList}" var="PptVO">
											<ul class="pptUserList">
												<tr id="${PptVO.fno}" style="color: black;">
													...
													<th><a class="title-tag" id="${PptVO.fno}" href="#">${PptVO.ppt_title}</a></th>
												</tr>
											</ul>
										</c:forEach>
										<!-- /.로그인한 정보에 따른 ppt 리스트 보여주기 -->
							...
							<!-- list paging 처리 -->
							<div class="col-md-8">
								<ul class="pagination pull-right list-num ">
									<c:if test="${pageMaker.prev ne 0}">
										<li id="pagePrev"><a href="${pageMaker.prev}">이전</a></li>
									</c:if>
									<c:forEach begin="${pageMaker.firstPage}"
										end="${pageMaker.lastPage}" var='idx'>
				...
				<div class="col-md-5">
					<div class="panel box-v3">
						...
						<div class="panel box-v4">
							<div class="panel-body btns-crud">
								<button id="circle2"
									class=" btn btn-circle btn-3d btn-sm btn-primary read-btn"
									value="primary">방송</button>
								<button
									class=" btn btn-circle btn-3d btn-sm btn-success create-btn"
									value="primary" id="createBtn">생성</button>
								<button class=" btn btn-circle btn-3d btn-sm btn-warning up-btn"
									value="primary" id="uploadBtn">수정</button>
								<button class=" btn btn-circle btn-3d btn-sm btn-danger del-btn"
						...
						<div class="panel-body">
							<div class="col-md-12 col-sm-12 col-xs-12">
								<div id="carousel-example-generic" class="carousel slide"
									...
									<a class="left carousel-control" id="prevBtn"
										href="#carousel-example-generic" role="button"
										data-slide="prev"> <span
										class="glyphicon glyphicon-chevron-left"></span></a> <a
										class="right carousel-control" id="nextBtn"
										href="#carousel-example-generic" role="button"
	...
	<!-- HOME으로 이동  -->
	<form method="get" id="index" action="../index"></form>

	<!-- 검색 시 조건이 없으면 원래 처음 화면으로 이동 -->
	<form method="get" id="move" action="myPage"></form>
	...
	<input id="infor" type="hidden" name="fno" value="1">
	...
	$(document).ready(function() {
		...
		$('#circle2').on("click", function(event) {
		    ...
		    $.ajax({
			 ...
			 //self.location = "http://192.168.0.76:8082/ppt?id="+pptID+"#&userid="+loginSession+"#/"; 
		...
		if(fnoVal!=1){
			...
			console.log("fno는 1이 아니다"+fnoVal);

										...
										<c:forEach items="${pptUserList}" var="PptVO">
											<ul class="pptUserList">
												<tr id="${PptVO.fno}">
													...
													<td><a class="title-tag" id="${PptVO.fno}" href="#">${PptVO.ppt_title}</a></td>
												</tr>
											</ul>
										</c:forEach>
										<!-- /.로그인한 정보에 따른 ppt 리스트 보여주기 -->
							...
							<div class="col-md-12 col-sm-12 col-xs-12">
								<div id="carousel-example-generic" class="carousel slide"
									...
									<a class="left carousel-control" id="prevBtn"
										...
										<a class="right carousel-control" id="nextBtn"
										href="#carousel-example-generic" role="button"
										data-slide="next"> 
...
<script>
	$(document).ready(function() {
		...
		$('#circle2').on("click", function(event) {
			...
			self.location = "http://192.168.0.28:8082/cc?id=9&userid="
						+ loginSession + "#/";
		...
		function pptView(fno) {
			...
			$('#carousel-example-generic')
					.append('<div class="carousel-inner" id="imgContext"></div>'
			...
			$.ajax({
				...
				success : function(data) {
					$.each(data, function(index, obj) {
						...
						if (index == 0) {
							$('#imgContext').append('<div class="item active">'
							...
							$('#imgContext').append('<div class="item">'
											+ '<img class="img-responsive"'
											+ 'data-src="holder.js/900x500/auto"'
											+ 'src="../ppt/show?name=' + obj.img + '">'
											+ '</div>'

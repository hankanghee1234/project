         ...
         <div class="col-md-12  profile-v1-cover-wrap" style="padding-right: 0px;">
            ...
            <img src="show?name=${read.uimg}">
               <div class="presenter-imformatiop" style="text-align: left; position: absolute;">
                  <!-- 유저 정보 출력 -->
                  <h3 class="user-name" style="color: black;">${read.username}</h3>
                  <h3 class="user-email" style="color: black;">${read.email}</h3>   
               </div>
               ...
               <div class="panel box-v3">               
                  ...
                  <div class="panel box-v4">            
                     <div class="panel-body btns-crud">
                        <button id="circle2" class=" btn btn-circle btn-3d btn-sm btn-primary read-btn"
                              value="primary">방송</button>      
                        <button class=" btn btn-circle btn-3d btn-sm btn-success create-btn"

...
<body>
			...
			<div class="col-md-8">
				<div class="row">
					...
					<div class="navbar-header">
						...
						<a class="navbar-brand" href="#">MY PPT Search</a>
					</div>
	...
	<div class="carousel slide START">
		<div class="col-md-8">
			<div class="row">
				<div class="carousel slide" id="carousel-9196">
					<ol class="carousel-indicators">
						<li class="active" data-slide-to="0" data-target="#carousel-9196"></li>
						<li data-slide-to="1" data-target="#carousel-9196"></li>
						<li data-slide-to="2" data-target="#carousel-9196"></li>
					</ol>
	...
	<div class="yui-b">
		<div class="col-md-8">
			<div class="row">
				<p class="text-left text-success lead">

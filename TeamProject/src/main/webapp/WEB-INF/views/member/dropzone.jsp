...
<body>
      ...
      <input class="w3-input w3-border w3-round-large" type="text" name="ppt_kind" placeholder="Field" value="">
      <p>
         <label class="w3-text-grey">&nbsp;&nbsp;&nbsp;제목</label>
      </p>
      <input class="w3-input w3-border w3-round-large" type="text" name="ppt_title" placeholder="Title" value="" >
      <p>
         <label class="w3-text-grey">&nbsp;&nbsp;&nbsp;내용</label>
      </p>
      <input class="w3-input w3-border w3-round-large" type="text" name="ppt_desc" placeholder="Content" value="">
      <br>
      </form>

...
<title>Insert title here</title>
  ...
  <link rel="stylesheet" type="text/css" href="/resources/asset/css/plugins/icheck/skins/flat/red.css">
...
<!--                   <div class="col-md-6" style="padding-top:20px;">
   ...
   <script
      src="/resources/asset/js/plugins/icheck.min.js"></script>
   <script
      src="/resources/asset/js/plugins/moment.min.js"></script>
   <script
      src="/resources/asset/js/plugins/mediaelement-and-player.min.js"></script>
   <script
      src="/resources/asset/js/plugins/jquery.nicescroll.js"></script>

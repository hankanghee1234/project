	...
	if (msg == 'registSUCCESS') {
		...
		$.getJSON("/ppt/chatList", function(list) { // 이 안에서 ppt 자료를 JSON data로 입력받아서 호출하는곳
			...
			$(list).each(function(index, data) {
				...
				chatList.append("<tr style='color: black'><th>" + data.ppt_kind + "</th><th><a class=Geust data-src='"+data.userid+"'href=http://192.168.0.28:8082/ppt?id="+data.fno+"#&userid="+data.userid+"#/ >"   + data.ppt_title+ "</a></th>     <th>"+data.userid+"</th></tr>");
				
				

			/*	<th>프로젝트</th>
				<th><a class="title-tag" id="22" href="#">파일</a></th>
				<th>user00</th>*/
